...
class HospitalSimulator:
    ...
    def __init__(self, patient: entitles.Patient):
        ...
        self.department1_button = tk.Button(self.root, text="Go to dentist", command=lambda: self.run("dentist"))
        ...
        self.department2_button = tk.Button(self.root, text="Go to emergency", command=lambda: self.run("emergency"))
        self.department2_button.grid(row=3, column=1, pady=10,padx=10)
        
        self.department3 = tk.Label(self.root, text="Physician")
        self.department3.grid(row=2, column=3, pady=10,padx=10)
        self.department3_button = tk.Button(self.root, text="Go to physician", command=lambda: self.run("physician"))
        self.department3_button.grid(row=3, column=3, pady=10,padx=10)
        
        self.department4 = tk.Label(self.root, text="Ultrasound")
        self.department4.grid(row=2, column=4, pady=10,padx=10)
        self.department4_button = tk.Button(self.root, text="Go to ultrasound", command=lambda: self.run("ultrasound"))
        self.department4_button.grid(row=3, column=4, pady=10,padx=10)
...
if __name__ == "__main__":
    ...
    patient = entitles.Patient(name="Manas", problem="Dental", bill=0)
